...
ポーゲンポール氏のデザイン思想は、彼女の主要な著作や論文、そして長年にわたる『Visible Language』誌の編集活動を通じて明確に示されている。その核心には、デザイン研究方法論の確立、学際的アプローチの奨励、そしてテクノロジーと人間の関係性に対する深い洞察がある。

**2.1 代表的著作の概観**

ポーゲンポール氏の思想を理解する上で重要な著作として、以下のものが挙げられる。

2.1.1 『Design Integrations: Research and Collaboration』（佐藤敬一氏との共編、2009年）  
本書は、現代のデザイン実践における研究と学際的協力の役割が増大していることを踏まえ、デザイン教育の革新的な再考を促すものである 5。寄稿者たちは、学術界とビジネス界の間の学際的協力に焦点を当てた新しいアプローチ方法を提言している。本書は、デザインの将来に焦点を当てた最初期の論考の一つであり、制度間のプロジェクト、異文化間の学習経験、多国籍ヘルスケアプロジェクトなど、具体的な事例を詳細に探求している。特に、デザイン実践と教育が「クラフト（職人的技能）」から「ディシプリン（学問分野）」へと移行する必要性を強く主張し、そのための研究と協力のあり方を論じている 7。  
2.1.2 『Design Theory To Go: Connecting 24 brief theories to practice』（2018年）  
本書は、デザイン理論をデザイン実践家や教育者にとってより身近で応用可能なものとして提示することを目的としている 28。直感的アプローチと論理的アプローチの両方をカバーし、アナロジー、アテンション、文化差、身体性、感情、ゲシュタルト、メディア、記譜法、リサーチ、レトリックなど、24の多様な理論を平易な言葉と豊富な図版（99点の図と27点の表）を用いて解説し、そのデザインへの貢献と実践的な応用方法を示している 28。本書で提示される理論は規範的なものではなく、デザイン行動に有用な基本的なモデル、原則、フレームワークを提供する記述的なものである点が特徴である 28。  
2.1.3 『Visible Language』誌における主要論文・論考  
ポーゲンポール氏は編集長としてだけでなく、著者としても『Visible Language』誌に重要な論考を寄稿している。

* "Visible Language in Transition"（Paul Michael Zenderとの共著、Vol. 47, No. 1, 2013）では、同誌の第3世代への移行期における進化と将来展望、そしてデザイン研究の新たな方向性について論じている 6。  
* "Reflections on Teaching Research: A Conversation with Meredith Davis, Mary Dyson, Judith Gregory"（Vol. 47, No. 1, 2013）は、デザイン研究の教育における課題や教育者間の視点の違い、具体的な提案について、著名な研究者たちとの対話を通じて探求している 29。  
* "Communication Design Failures, Part 1 & 2"（Dietmar R. Winklerとの共同編集による特集号、Vol. 43, No. 2-3, 2009 & Vol. 44, No. 1, 2010）の序文「Celebrating Failure」および結論「In Closing… What have we learned from failure?」では、デザイン分野の進歩のためには失敗事例の批判的検討が不可欠であると主張し、その重要性を論じている 6。

**2.2 デザイン研究方法論と学際的アプローチの提唱**

ポーゲンポール氏は、デザイン研究が学術的文脈とビジネス文脈の双方において、特定の類型論に基づいて発展し、多様な研究理論と戦略を用いるべきであると主張している 7。彼女の著作、特に『Design Integrations』では、学際的協力の重要性が一貫して強調されており、制度横断的な学術プロジェクト、異文化間での学習経験、さらには多国籍ヘルスケアプロジェクトといった具体的な事例を通じて、その実践方法と意義が探求されている 5。彼女はデザインを、単に美しい形態や機能的な解決策を生み出す活動としてだけでなく、その成果物が鑑賞者、環境、素材、あるいは社会文化といったより広範な文脈にどのような影響を与えるかを省察する活動として捉えている 31。  
ポーゲンポール氏のデザイン思想の核心には、デザインを孤立した専門技能の集合体としてではなく、多様な分野や文脈と積極的に関わり合い、それらを統合していく知的な営為として捉え直そうとする強い意志が見られる。この「統合的（integrative）」な視点は、現代社会におけるデザインが直面する問題の複雑化に対応するための必然的な要請とも言えるだろう。彼女の著作のタイトル自体が「統合」をキーワードとしており（例：『Design Integrations』）、その内容は学際的協力の重要性を繰り返し説いている。また、彼女はデザイン研究を「実践共同体（communities of practice）」として捉え、より包括的で社会と連携したアプローチを提唱しており 52、これはデザインが単なる美的造形や技術的解決に留まらず、社会的・文化的な課題解決に積極的に貢献しうるという信念に基づいている。  
**2.3 人間中心デザインとテクノロジーの人間化への視点**

ポーゲンポール氏は、デザインにおける人間中心の立場を一貫して取り、教育者として、学生がテクノロジーを人間的な視点から捉え直し、それをより人間的なものにする（humanize technology）ための能力を養うこと、そして他者と創造的かつ協力的に働くことを学ぶ手助けをすることを目指してきた 1。彼女はインタラクションを「システムの変数または部分間の相互的または互恵的な影響のプロセス」であり、「各行動が先行する行動に応答し、後続の行動によって応答される一連の行動」と定義している 55。  
テクノロジーが急速に発展し、社会のあらゆる側面に浸透していく時代背景の中で、ポーゲンポール氏はテクノロジーそのものの進化を追うのではなく、それを利用する人間と、人間とテクノロジーとの間に生じる「インタラクション」に焦点を当てた。これは、デザインが果たすべき倫理的・社会的役割を追求する姿勢の表れと言える。香港理工大学におけるインタラクションデザイン修士課程の開発 1 や、「テクノロジーを人間化する」という教育目標 1 は、技術中心主義への警鐘と人間性の回復への志向を明確に示している。インタラクションを「相互的影響のプロセス」と捉える彼女の定義 55 は、ユーザーを受動的な情報受信者としてではなく、システムとの能動的な対話者として位置づける、人間中心のデザイン思想を色濃く反映している。  
**表2：シャロン・ポーゲンポール氏の主要著作とテーマ**

| 著作名 | 年 | 主要テーマ・貢献 | 関連資料 |
| :---- | :---- | :---- | :---- |
| *Design Integrations: Research and Collaboration* (Keiichi Satoと共編) | 2009年 | デザイン教育の革新、学際的協力、研究と実践の統合、クラフトからディシプリンへの移行 | 1 |
| *Design Theory To Go: Connecting 24 brief theories to practice* | 2018年 | デザイン理論の実践的応用、24の多様な理論の解説（アナロジー、アテンション、文化差、身体性、感情、ゲシュタルト、メディア、記譜法、リサーチ、レトリック等） | 28 |
| *Visible Language* 誌 "Visible Language in Transition" (P.M. Zenderと共著) | 2013年 | ジャーナルの進化と将来展望、デザイン研究の新たな方向性 | 6 |
| *Visible Language* 誌 "Reflections on Teaching Research" (対談) | 2013年 | デザイン研究教育の課題と提案 | 36 |
| *Visible Language* 誌 "Communication Design Failures, Part 1 & 2" (D.R. Winklerと共同編集) | 2009年, 2010年 | デザインにおける失敗の研究の重要性、失敗からの教訓 | 6 |
...
* Woods, L. (2024). The design thinking paradigm: Mapping the terrain of people and places. *PrePress*. 56
...
20. Keiichi Sato \- The University of Chicago Press, accessed May 18, 2025, [https://press.uchicago.edu/ucp/books/author/S/K/au6921810.html](https://press.uchicago.edu/ucp/books/author/S/K/au6921810.html)  
...
41. Design for Communication: a collaborative practice to amplify qualities of sustainability. \- \- UAL Research Online, accessed May 18, 2025, [https://ualresearchonline.arts.ac.uk/id/eprint/13453/1/THESIS%20%20VOL1%20JCL.pdf](https://ualresearchonline.arts.ac.uk/id/eprint/13453/1/THESIS%20%20VOL1%20JCL.pdf)  
