...
# **プロセスが生成するデザイン：コンディショナル・デザインの思想、実践、そして現代への影響**

![](https://m.media-amazon.com/images/I/7110jZIMe8L._UF1000,1000_QL80_.jpg)

## **序論**

21世紀初頭のオランダ。デザインの世界がデジタル化の波に乗り、新たな表現と方法論を模索していた時代に、4人のクリエイター、ルーナ・マウラー（Luna Maurer）、エド・パウルス（Edo Paulus）、ジョナサン・パッキー（Jonathan Puckey）、そしてルール・ウッターズ（Roel Wouters）は、アムステルダムにあるマウラーのキッチンテーブルを囲み、デザインの未来を再定義する議論を重ねていた 1。彼らが共同で生み出した「コンディショナル・デザイン（Conditional Design）」は、単なる新しいスタイルや美学ではなく、デザインの根幹を問い直す方法論的転換であった。それは、最終的な成果物（プロダクト）の完成度を追求するのではなく、その生成過程（プロセス）そのものに価値を見出すという、ラディカルな思想である 2。

彼らのアプローチは、ルールと制約という論理的な枠組みを設定し、その中で人間や環境からの偶発的な「インプット」を取り込むことで、予測不可能な結果を生み出すことを特徴とする 4。この思想は、メディアとテクノロジーが加速的に変化し、データ駆動型社会が到来した現代に対する、彼らなりの応答であった 4。本レポートでは、このコンディショナル・デザインという運動を主導した4人の経歴と業績を詳細に分析し、その思想的背景、代表的な実践、そして現代のジェネレーティブ・デザインやUI/UXデザインシステムに与えた深遠な影響について、包括的に論じる。彼らの活動は、単なるデジタル時代のデザイン実験に留まらず、デザイナーの役割そのものを、制作者から「プロセスの設計者」へと変容させる可能性を提示したのである。

## **第1章：コンディショナル・デザインの誕生と理念**

### **1.1. メンバーの経歴と出会い**

コンディショナル・デザインを形成した4人は、それぞれ異なる専門分野のバックグラウンドを持ち、その多様性がコレクティブの独自の強みとなった。

**ルーナ・マウラー**はドイツ・シュトゥットガルト出身のデザイナー兼アーティストである。アムステルダムのヘリット・リートフェルト・アカデミーとサンドベルク・インスティテュートで学び、インタラクションおよびメディアデザインの分野で活動している 1。彼女の作品は、デジタル技術と物理的な体験を融合させ、人間の特性を探求することを特徴とする 8。後にウッターズ、パッキーと共に設立したインタラクティブデザインスタジオ「モニカー（Moniker）」での活動は、コンディショナル・デザインの思想をさらに発展させる重要なプラットフォームとなった 9。

**エド・パウルス**は、オランダのサウンドアーティストであり、デルフト工科大学で建築を、ユトレヒト芸術学校でオーディオデザインを学んだ異色の経歴を持つ 12。彼の専門は、サウンドインスタレーションや自動音楽生成ソフトウェアなど、ジェネレーティブ（生成的）なプロセスを用いた創作活動である。パウルスは、アルゴリズミックな創作手法を用いることで、人間の主観的な感情表現や恣意的な意思決定から解放された音楽を追求している 13。

**ジョナサン・パッキー**は、アムステルダムを拠点とするインタラクティブデザイナーであり、プログラマーでもある 14。13歳でウェブサイトのデザインとプログラミングを始め、リートフェルト・アカデミーで学んだ後、テクノロジーを表現のゴールではなく、ゴールを達成するための手段として捉えるようになる 16。彼は、Adobe Illustratorの機能を拡張する「Scriptographer」や、HTML5 Canvas上でベクターグラフィックスを扱うためのフレームワーク「Paper.js」といった、多くのデザイナーに影響を与えたツールの開発者として知られている 17。

**ルール・ウッターズ**は、グラフィックデザイナーとしての訓練を受け、現在は「コンディショナル・デザイナー」兼ディレクターとして活動している 22。彼の作品は、私たちが日常的に使用するシステムやテクノロジーを考察の対象とし、既存のシステムの根幹を脱構築したり、あるいは新しいシステムを設計して人々がそれを使用する際に何が起こるかを観察したりするアプローチを取る 24。マウラーとはサンドベルク・インスティテュートで出会い、以来多くのパフォーマンス的なプロジェクトで協働している 1。

この4人は2008年頃に集まり、毎週火曜日にマウラーの家で会合を開き、コンディショナル・デザインの思想を体系化していった 1。グラフィック、サウンド、コード、パフォーマンスといった異なる領域の専門知識が交差することで、彼らの方法論は多角的で豊かなものとなった。

### **1.2. コンディショナル・デザイン・マニフェスト**

2008年、彼らは自らのデザインアプローチを体系化し、「コンディショナル・デザイン・マニフェスト」として発表した。このマニフェストは、彼らの活動の思想的根幹をなすものであり、「プロセス」「ロジック」「インプット」という三つの核となる理念で構成されている 4。

プロセスはプロダクトである (Process is the product)  
この理念は、コンディショナル・デザインの最も根本的な原則である。伝統的なデザインが最終的な成果物（形態）の完成度を目的とするのに対し、彼らは生成の過程そのものに価値を見出す。マニフェストには「プロセスの最も重要な側面は、時間、関係性、そして変化である。プロセスは形態（forms）ではなく、フォーメーション（formations）を生み出す」と記されている 4。これは、静的なオブジェクトではなく、環境に適応し、変化し続ける動的なシステムを志向することを示唆している。この考え方は、参加者が共同でドローイングを行う「The Perfect Circle」のようなワークショップや、観客の行動によって作品が生成されるライブパフォーマンス「Book Nodes & Edges」などで具現化されている 25。  
ロジックはツールである (Logic is our tool)  
コンディショナル・デザインにおける「ロジック」とは、予測可能な結果を導き出すためのものではない。むしろ、「把握不可能なものを際立たせるための我々の手法」として位置づけられる 4。明確で理解可能なルールや制約を設計することで、その枠組みの中で参加者が「遊ぶ」ことを促し、予測不可能な創発的パターンを探求する。恣意的なランダム性を避け、「差異には理由があるべきだ」と主張することで、生成される結果に一貫した論理的背景を与えている 4。この原則は、ルールに基づいてドローイングを行う「Hatching」ワークショップや、Puckeyが開発したScriptographerのようなクリエイティブ・コーディングのツール開発に色濃く反映されている 17。  
インプットは素材である (Input is our material)  
彼らのシステムは自己完結しておらず、常に外部からの入力を求めている。マニフェストは「インプットは、我々の外部にある複雑な環境、すなわち自然、社会、そしてその人間的相互作用から来るべきである」と述べる 4。これにより、彼らの作品は環境応答的かつ参加型となり、デザイナーは完全な作者としての権威を手放す。ユーザーのカーソルの動きを記録して作られたミュージックビデオ「Do Not Touch」や、鑑賞者の物理的な移動データで地球を描く「Painted Earth」は、この理念を大規模に実現したプロジェクトである 27。  
これらの理念は、デザイナーの役割を、完成されたオブジェクトの創造者から、創造のための「条件」や「可能性の場」を設計するメタデザイナーへと移行させる。これは、デザインにおける作者性の概念を、個人のビジョンから、プロセスによって媒介される集団的な行為へと根本的に再定義する試みであった。

| マニフェストの理念 (Manifesto Principle) | 解説 (Explanation) | 実践例 (Practical Example) |
| :---- | :---- | :---- |
...
これらのワークショップの集大成として、2013年に『Conditional Design Workbook』が出版された 3。この本は、彼らの方法論を解説する理論書ではなく、読者自身がワークショップを実践できる「ドゥブック（do-book）」として構成されている 3。これにより、彼らの思想は閉じたものではなく、誰もが実践し、応用できるオープンな方法論として世界中に広まることとなった。
...
25. Conditional Design, accessed June 17, 2025, [https://dunbargraphics.hotglue.me/?Conditional%20Design/](https://dunbargraphics.hotglue.me/?Conditional+Design/)  
...
48. Conditional Design Workbook by Studio Moniker | Goodreads, accessed June 17, 2025, [https://www.goodreads.com/book/show/17195785-conditional-design-workbook](https://www.goodreads.com/book/show/17195785-conditional-design-workbook)  
...
71. A guide to type styles. \- Monotype., accessed June 17, 2025, [https://www.monotype.com/resources/guide-type-styles](https://www.monotype.com/resources/guide-type-styles)  
...
94. インストラクショナルデザイン \- \- Ｃ＆Ｌデザイン, accessed June 17, 2025, [https://www.c-l-d.com/id%E5%85%A5%E9%96%80%E8%AC%9B%E5%BA%A7](https://www.c-l-d.com/id%E5%85%A5%E9%96%80%E8%AC%9B%E5%BA%A7)  
...
119. Workshops in Tokyo | Events | Metropolis Japan, accessed June 17, 2025, [https://metropolisjapan.com/about-town-autumn-2021/](https://metropolisjapan.com/about-town-autumn-2021/)  
